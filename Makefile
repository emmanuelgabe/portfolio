...
test-local:
	...
	@echo "[SUCCESS] Environnement local demarré sur http://localhost:8081"
...
test-staging:
	...
	@echo "[SUCCESS] Environnement staging demarré sur http://localhost:3000"
...
test-prod:
	...
	@echo "[SUCCESS] Environnement production demarré sur http://localhost:80"
...
clean-local:
	...
	@echo "[SUCCESS] Environnement local nettoyé"
...
clean-staging:
	...
	@echo "[SUCCESS] Environnement staging nettoyé"
...
clean-prod:
	...
	@echo "[SUCCESS] Environnement production nettoyé"

# Nettoyage complet de tous les environnements
clean-all: clean-local clean-staging clean-prod
	@echo "[SUCCESS] Tous les environnements nettoyés"
